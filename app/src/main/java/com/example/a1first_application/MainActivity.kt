...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val post = Post(12, "2020-12-09 19:20:03", "Petrov", "This is simple content", false)
    ...
    fun time(post: Post) {
        ...
        val currentSum = currentHour + currentMinutes + currentSeconds + currentMonth + currentDay + currentYear
